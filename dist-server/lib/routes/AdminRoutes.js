...
var _AdminModel = _interopRequireDefault(require("../model/AdminModel"));

var _httpStatus = _interopRequireDefault(require("../utils/httpStatus"));

var adminRoutes = _express["default"].Router(); //todo: GetAll Data


adminRoutes.get("/admin", /*#__PURE__*/function () {
...
adminRoutes.post("/admin", /*#__PURE__*/function () {
    ...
    return _regenerator["default"].wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.next = 2;
            return _AdminModel["default"].create(req.body);
